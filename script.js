/* ============================================================
   ...
   Deep-link openers · library counts · search

   EVERYTHING HERE NEEDS THE LIBRARY. This file reads TIPS, so it is
   only loaded by pages that render fixes from the data (home, the two
   hubs, diagnose, ai). Static fix pages under windows/<slug>/ and
   mac/<slug>/ are complete HTML and load page.js alone.

   Site chrome — nav toggle, theme, back-to-top, reveals, counters,
   scrollspy, footer year — lives in page.js, which every page loads
   LAST. The reveal and counter observers must run after the render
   functions below have injected their markup and filled [data-count].
   ============================================================ */
