/* ============================================================
   ...
   Fields:
     ...
     gotchas     optional array of strings — what actually goes wrong with THIS fix and
                 what to do about it. Rendered as "What usually goes wrong" on the fix
                 page, below the steps. Use it where brevity costs the reader something:
                 destructive or irreversible work, anything over ~20 minutes, and the
                 failure modes a 4-step summary has to leave out. Most fixes should NOT
                 have one — the short step list is the product. Omit the field entirely
   ...
   THE ONE MANUAL STEP: index.html is hand-maintained, and crawlers read it
   before JS runs, so its counts are hardcoded. After changing the number of
   tips, update in index.html:
     og:description                 ("89 tested fixes")
     the [data-tip-count] fallbacks (the inline numbers JS overwrites)
   test/seo.test.mjs asserts both against this array, so a stale number fails
   the build rather than shipping. The hubs, every fix page, the sitemap and
   the meta descriptions under windows/ and mac/ are generated by
   build/generate.mjs and need no manual edit — re-run it instead.
   ============================================================ */
...
const TIPS = [
  ...
  },
  {
    ...
    gotchas: [
      "Clone the whole drive, not just the C: partition. The small hidden EFI and recovery partitions are what actually make it bootable — miss them and you get a perfect copy of your files that won't start.",
      "If the SSD is smaller than the old drive, shrink the old partition to fit before cloning. This is the single most common reason a clone refuses to start.",
      "Set SATA mode to AHCI, or enable NVMe, in the BIOS before the first boot. Skip it and Windows greets you with INACCESSIBLE_BOOT_DEVICE on a drive that is in fact fine.",
      "Unplug the old drive for the first boot from the SSD. With both connected, the boot manager can load from the new drive but still point at the old one, and you'll think the clone failed.",
      "Keep the old drive untouched for a month before you wipe it. It is your only way back, and the things that turn out to be missing — a licence, a save folder, a mail archive — surface in week three, not on day one.",
    ],
    risk_level: "high",
    reversible: false,
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-ssd-upgrade.svg",
    cat: "hardware",
    difficulty: 2,
    time: "1 hr",
    win: "Any",
    ...
    steps: [
      ...
      "Verify it boots — then leave the old drive alone for a month before you reuse it. Something always turns out to be missing in week three",
    ],
  },
  {
    title: "Upgrade your RAM (and match it)",
    gotchas: [
      "Two sticks go in the matching-coloured slots — usually the 2nd and 4th counting from the CPU, not the two side by side. The wrong pair of slots gets you single-channel and quietly costs you the speed you just paid for. The motherboard manual has the diagram.",
      "Fitting the RAM is only half of it. Enable XMP (Intel) or EXPO (AMD) in the BIOS afterwards, or the sticks run at the slow default speed regardless of what's printed on the heatsink.",
      "Unplug at the wall and hold the power button for ten seconds before you open the case. That drains the residual charge that's still in the board after shutdown.",
      "Mixing a new stick with your existing one usually works, but both drop to the slower one's timings. A matched kit is tested to run together; two singles are not.",
      "Won't turn on after fitting? Reseat before you assume the stick is dead. Most 'faulty RAM' is one end that never fully clicked in.",
    ],
    risk_level: "low",
    reversible: true,
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-ram-dual-channel.svg",
    cat: "hardware",
    difficulty: 2,
    time: "30 min",
    win: "Any",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-transparency-off.svg",
    cat: "windows",
    difficulty: 1,
    time: "2 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-temp-files-clean.svg",
    cat: "cleaning",
    difficulty: 1,
    time: "5 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-uninstall-unused.svg",
    cat: "cleaning",
    difficulty: 1,
    time: "10 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-driver-order.svg",
    cat: "maintenance",
    difficulty: 1,
    time: "15 min",
    win: "Any",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-disk-health.svg",
    cat: "maintenance",
    difficulty: 2,
    time: "15 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    gotchas: [
      "OneDrive and Google Drive are sync, not backup. Delete a file or let ransomware encrypt it and the change reaches the cloud copy in seconds. They only count as a copy if version history is on and you know how to roll it back.",
      "File History protects the folders it was told about and nothing else. Check that list — anything kept outside your user folder is excluded by default, which is exactly where games, projects and code usually live.",
      "A second drive in the same drawer is one copy, not two. The off-site copy is the one that survives a fire, a flood or a burglary, and it's the one people skip.",
      "An external drive left permanently connected is reachable by anything that gets onto the PC, ransomware included. Unplug it between backups.",
    ],
    risk_level: "low",
    reversible: true,
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-backup-321.svg",
    cat: "security",
    difficulty: 2,
    time: "30 min",
    win: "Any",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-game-stutter-checklist.svg",
    cat: "gaming",
    difficulty: 1,
    time: "15 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-game-mode.svg",
    cat: "gaming",
    difficulty: 1,
    time: "1 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-input-lag.svg",
    cat: "gaming",
    difficulty: 2,
    time: "20 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-account-hardening.svg",
    cat: "security",
    difficulty: 1,
    time: "20 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-no-pc-optimizers.svg",
    cat: "security",
    difficulty: 1,
    time: "10 min",
    win: "Any",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-system-file-repair.svg",
    cat: "maintenance",
    difficulty: 2,
    time: "30 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-19",
    diagram: "diagrams/win-dns-stack-reset.svg",
    cat: "maintenance",
    difficulty: 2,
    time: "10 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-nic-power.svg",
    cat: "windows",
    difficulty: 2,
    time: "10 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    gotchas: [
      "Photograph each screen before you change anything. UEFI has no undo, and 'load optimised defaults' also throws away settings you wanted to keep.",
      "One setting at a time, reboot in between. Change five at once and a machine that won't start tells you nothing about which one did it.",
      "XMP/EXPO is an overclock, just a pre-packaged one. Not every kit hits its rated speed on every board — if the PC gets flaky after enabling it, that's the first thing to turn back off.",
      "If it won't post at all, the fix is a CMOS clear, not the UEFI menu you can no longer reach: power off at the wall, then move the CLR_CMOS jumper or pull the board battery for a minute.",
      "The names vary by manufacturer. Resizable BAR may appear as 'Above 4G Decoding' plus 'Re-Size BAR Support', and virtualisation is VT-x on Intel but SVM on AMD.",
    ],
    risk_level: "high",
    reversible: true,
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-bios-five.svg",
    cat: "hardware",
    difficulty: 3,
    time: "20 min",
    win: "Any",
  ...
  },
  {
    ...
    gotchas: [
      "Controlled folder access blocks legitimate software too. Games writing saves, Photoshop, backup tools and installers all get stopped, and you'll spend a week adding them under 'Allow an app through'. Switch it on when you have time for that, not the night before a deadline.",
      "Memory integrity refuses to enable if an old driver doesn't support it. Windows names the offending driver — update or remove that, rather than abandoning the setting.",
      "A backup only saves you if the ransomware can't reach it. A permanently plugged-in external drive, or a synced cloud folder, gets encrypted along with everything else.",
      "Test one restore now, while nothing is wrong. Discovering the backup doesn't restore is much cheaper today than on the morning you need it.",
    ],
    risk_level: "medium",
    reversible: true,
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-ransomware-shield.svg",
    cat: "security",
    difficulty: 2,
    time: "20 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-search-index.svg",
    cat: "windows",
    difficulty: 1,
    time: "5 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-game-saves.svg",
    cat: "gaming",
    difficulty: 1,
    time: "5 min",
    win: "Any",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-desktop-pass.svg",
    cat: "windows",
    difficulty: 1,
    time: "15 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-slow-order-of-attack.svg",
    cat: "speed",
    difficulty: 1,
    time: "15 min",
    win: "Win 10 / 11",
    ...
    steps: [
      "Task Manager → Performance: is the Disk at 100%? (that's your HDD or a dying drive — the answer)",
      "Processes tab sorted by Memory or CPU: is something you don't recognise eating resources?",
      "Did a Windows Update land last night? Sometimes a bad driver updates itself",
      "Run sfc /scannow — corrupted system files present as 'random slowness', not crashes",
    ],
  },
  {
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/mac-updates-safe-way.svg",
    cat: "mac",
    group: "security",
    difficulty: 1,
    time: "10 min",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/mac-sluggish-macbook.svg",
    cat: "mac",
    group: "speed",
    difficulty: 1,
    time: "5 min",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-memory-hogs.svg",
    cat: "speed",
    difficulty: 2,
    time: "10 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-fast-transfers.svg",
    cat: "windows",
    difficulty: 1,
    time: "5 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-location-off.svg",
    cat: "security",
    difficulty: 1,
    time: "5 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-local-account.svg",
    cat: "security",
    difficulty: 2,
    time: "10 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-chrome-tighten.svg",
    cat: "security",
    difficulty: 1,
    time: "10 min",
    win: "Any",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-defender-sharp.svg",
    cat: "security",
    difficulty: 1,
    time: "15 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-bundleware-dodge.svg",
    cat: "cleaning",
    difficulty: 1,
    time: "5 min",
    win: "Any",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-drive-optimize.svg",
    cat: "maintenance",
    difficulty: 1,
    time: "5 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-shortcuts.svg",
    cat: "windows",
    difficulty: 1,
    time: "5 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-powertoys.svg",
    cat: "windows",
    difficulty: 1,
    time: "10 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    gotchas: [
      "Write the new router admin password down before you save it. Getting it wrong locks you out of your own router, and the only way back is a factory reset that undoes everything else you just did.",
      "Renaming the network or changing the passphrase disconnects everything at once — phones, laptops, the TV, the printer, the thermostat, the doorbell, every smart plug. Budget an hour to reconnect them, and don't do it while someone's working.",
      "Older devices don't understand WPA3. If something refuses to rejoin, set the router to mixed WPA2/WPA3 rather than dropping the whole network back to WPA2.",
      "Plenty of smart-home gear can only see 2.4 GHz. If a device vanishes after the rename, check whether the 2.4 GHz band needs its own network name for that device to find it.",
    ],
    risk_level: "medium",
    reversible: true,
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-wifi-lockdown.svg",
    cat: "security",
    difficulty: 2,
    time: "15 min",
    win: "Any",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-no-email-secrets.svg",
    cat: "security",
    difficulty: 1,
    time: "10 min",
    win: "Any",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-bitlocker-on.svg",
    cat: "security",
    difficulty: 1,
    time: "5 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-battery-age.svg",
    cat: "maintenance",
    difficulty: 1,
    time: "10 min",
    win: "Any",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-virtual-desktops.svg",
    cat: "windows",
    difficulty: 1,
    time: "5 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-19",
    diagram: "diagrams/win-wifi-three-switches.svg",
    cat: "windows",
    difficulty: 1,
    time: "5 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/mac-spotlight-indexing.svg",
    cat: "mac",
    group: "speed",
    difficulty: 2,
    time: "5 min",
  ...
  },
  {
    ...
    gotchas: [
      "If FileVault is on, Recovery asks for a user password before Disk Utility can even see the disk. There is no way past that prompt — no reset, no bypass. The password is the requirement.",
      "In Disk Utility, switch on View → Show All Devices and run First Aid from the bottom up: physical device first, then the container, then the volume. Running it on the volume alone skips the layer that is usually the broken one.",
      "'Reinstall macOS' from Recovery isn't necessarily the version you were running — on Intel Macs it can offer the one the machine shipped with. Expect a large download and several hours on a slow connection.",
      "No chime, no fan, no light at all is a power problem rather than a software one. Try a different charger and cable before you go anywhere near Recovery.",
    ],
    risk_level: "medium",
    reversible: true,
    ...
    updated: "2026-08-18",
    diagram: "diagrams/mac-wont-start-up.svg",
    cat: "mac",
    group: "fixes",
    difficulty: 2,
    time: "30 min",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/mac-first-aid-drives.svg",
    cat: "mac",
    group: "fixes",
    difficulty: 1,
    time: "10 min",
  ...
  },
  {
    ...
    gotchas: [
      "Time Machine erases the disk you give it. Anything already on that drive is gone — start with an empty one, or move its contents off first.",
      "Size the drive at two to three times your data, not merely larger than it. Time Machine keeps versions, so a disk barely bigger than your Mac fills within weeks and then quietly starts discarding your oldest history.",
      "One backup drive rebuilds the single point of failure you were trying to remove. Time Machine happily rotates between multiple disks — use two, and keep one elsewhere.",
      "Backups stop while the drive is unplugged and nothing warns you. If you use a portable disk, glance at the Time Machine menu now and then to check the date of the last successful backup.",
    ],
    risk_level: "low",
    reversible: true,
  ...
  },
  {
    ...
    gotchas: [
      "The iCloud unlock option is only as strong as your Apple account. Turn on two-factor there first, or you've moved the lock rather than added one.",
      "If you choose the recovery key instead, that key is genuinely the only way back in. Apple cannot reset it for you — store it off the Mac, on paper or in a password manager.",
      "Keep the Mac plugged in for the first encryption pass. It runs for a few hours in the background, and letting the battery die partway through is asking for trouble.",
      "Multiple accounts on the Mac? Each user has to be enabled for FileVault individually, or they simply can't unlock the machine after a restart.",
    ],
    risk_level: "medium",
    reversible: true,
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/mac-gatekeeper-open.svg",
    cat: "mac",
    group: "fixes",
    difficulty: 1,
    time: "2 min",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/mac-slow-wifi.svg",
    cat: "mac",
    group: "fixes",
    difficulty: 1,
    time: "10 min",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/mac-safari-clean-out.svg",
    cat: "mac",
    group: "speed",
    difficulty: 1,
    time: "5 min",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-ssd-pick-fast.svg",
    cat: "hardware",
    difficulty: 1,
    time: "5 min",
    win: "Any",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-psu-sizing.svg",
    cat: "hardware",
    difficulty: 2,
    time: "15 min",
    win: "Any",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-airflow-pass.svg",
    cat: "hardware",
    difficulty: 2,
    time: "45 min",
    win: "Any",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-win10-eol.svg",
    cat: "maintenance",
    difficulty: 1,
    time: "15 min",
    win: "Win 10",
  ...
  },
  {
    ...
    updated: "2026-08-19",
    diagram: "diagrams/win-bt-pairing-reset.svg",
    cat: "windows",
    difficulty: 1,
    time: "5 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-19",
    diagram: "diagrams/win-usb-device-manager.svg",
    cat: "windows",
    difficulty: 2,
    time: "10 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-19",
    diagram: "diagrams/win-power-check.svg",
    cat: "maintenance",
    difficulty: 1,
    time: "5 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-19",
    diagram: "diagrams/win-black-screen-path.svg",
    cat: "maintenance",
    difficulty: 1,
    time: "5 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-phishing-spot.svg",
    cat: "security",
    difficulty: 1,
    time: "10 min",
    win: "Any",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-new-pc-move.svg",
    cat: "windows",
    difficulty: 2,
    time: "60 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-18",
    diagram: "diagrams/win-edge-firefox-tighten.svg",
    cat: "security",
    difficulty: 1,
    time: "10 min",
    win: "Any",
  ...
  /* ---------- Phase 3.2.2B — Windows P0 completion (update + CPU triage) ---------- */
  {
    ...
    updated: "2026-08-19",
    diagram: "diagrams/win-update-stuck-retry.svg",
    cat: "maintenance",
    difficulty: 1,
    time: "10 min",
    win: "Win 10 / 11",
  ...
  },
  {
    ...
    updated: "2026-08-19",
    diagram: "diagrams/win-cpu-pegged.svg",
    cat: "speed",
    difficulty: 1,
    time: "5 min",
    win: "Win 10 / 11",
     ...
     misbehave); these cover the gaps that had no approved fix at all. */
  {
    ...
    updated: "2026-08-19",
    diagram: "diagrams/mac-network-reset.svg",
    cat: "mac",
    group: "fixes",
    difficulty: 2,
    time: "10 min",
  ...
  },
  {
    ...
    updated: "2026-08-19",
    diagram: "diagrams/mac-no-sound-output.svg",
    cat: "mac",
    group: "fixes",
    difficulty: 1,
    time: "5 min",
  ...
  },
  {
    ...
    updated: "2026-08-19",
    diagram: "diagrams/mac-monitor-not-detected.svg",
    cat: "mac",
    group: "fixes",
    difficulty: 1,
    time: "5 min",
  ...
  },
  {
    ...
    updated: "2026-08-19",
    diagram: "diagrams/mac-bt-pairing-reset.svg",
    cat: "mac",
    group: "fixes",
    difficulty: 1,
    time: "5 min",
       ...
       and browsing; see Phase 3.3 report, Part G + known limitations. */
  {
    ...
    updated: "2026-08-19",
    diagram: "diagrams/mac-input-restart-pass.svg",
    cat: "mac",
    group: "fixes",
    difficulty: 1,
    time: "5 min",
  ...
  },
  {
    ...
    updated: "2026-08-19",
    diagram: "diagrams/mac-mic-input-first.svg",
    cat: "mac",
    group: "fixes",
    difficulty: 1,
    time: "5 min",
  ...
  },
  {
    ...
    updated: "2026-08-19",
    diagram: "diagrams/mac-mic-permission.svg",
    cat: "mac",
    group: "fixes",
    difficulty: 1,
    time: "5 min",
